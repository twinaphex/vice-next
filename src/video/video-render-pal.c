...
static void video_render_pal_main(video_render_config_t *config, BYTE *src, BYTE *trg, int width, int height, int xs, int ys, int xt, int yt, int pitchs, int pitcht, int depth, viewport_t *viewport)
{
	...
	if ((rendermode == VIDEO_RENDER_PAL_1X1 || rendermode == VIDEO_RENDER_PAL_2X2) && video_resources.pal_scanlineshade <= 0)
		doublescan = 0;
